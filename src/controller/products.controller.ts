...
export class ProductController {
  static async addProduct(request: Request, h: ResponseToolkit) {
    try {
  ...
  static async getAllProducts(request: Request, h: ResponseToolkit) {
    try {
  ...
  //filter products
  static async filterByCategory(request: Request, h: ResponseToolkit) {
    try {
      ...
      console.log(error);
      return h
        .response({ message: "Error filtering products by category" })
        .code(500);
    }
  };

  static async getProduct(request: Request, h: ResponseToolkit) {
    try {
