...
export class UserController {
  //------------------- User signup ------------
  static signup = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  //------------------- User login ------------------------
  static login = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  //--------------------- user logout -- -  -- -- - - - -- 
  static logout = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  // -----  -- --  - - get User profile ---- 
  static getProfile = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  //---------------update profile---------
  static updateProfile = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
      const customerId = request.auth.credentials.customerId; // Extract customer ID from authenticated token
  ...
  static deleteProfile = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  // forget password
  static forgetPassword = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  // reset password
  static resetPassword =async(request: Hapi.Request, h: Hapi.ResponseToolkit) =>{
    ...
    if (redisOTP == otp) {
      ...
      const update = await Customer.findOneAndUpdate({ email: email }, { $set: { password: hashedPassword } });
      if (update) {
