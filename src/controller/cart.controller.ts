...
export class CartController {
  ...
  static addToCart = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  static updateCartItem = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
  ...
  static removeCartItem = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
      const customerId = request.auth.credentials.customerId;
      const productId = request.params.productId;
  ...
  static getCart = async (request: Hapi.Request, h: Hapi.ResponseToolkit) => {
    try {
      const customerId = request.auth.credentials.customerId;
